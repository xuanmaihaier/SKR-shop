<template>
  <div class="myPageSnb">
    <div class="myPageSnbTop">
      <ul>
        <li v-for="item in typeOne" :key="item">
          <span>{{ item }}</span>
        </li>
      </ul>
    </div>
    <div class="myPageSnbBot">
      <div class="innerContent" v-show="isShow">
        <div class="inner">
          <ul v-for="(item, index) in typeTwo" :key="index">
