<template>
    <div id="address_detail" v-show="isShow">
        ...
        <div>
            ...
            <a-select v-model="provinceCode"
                      style="width: 120px"
                      @change="provinceChange(provinceCode)">
                <a-select-option v-for="(province,code) in provinces"
                                 :value="code"
                                 :key="code">
                    {{province.name}}
                </a-select-option>
            ...
            <a-select v-model="cityCode"
                      style="width: 120px"
                      @change="cityChange(cityCode)">
                <a-select-option v-for="(city,code) in cities"
                                 :value="code"
                                 :key="code">
                    {{ city.name }}
                </a-select-option>
            ...
            <a-select v-model="areaCode"
                      style="width: 120px"
                      @change="areaChange">
                <a-select-option v-for="(area,code) in areas"
                                 :value="code"
                                 :key="code">
                    {{ area }}
                </a-select-option>
